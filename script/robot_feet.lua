...
STEP_FORWARD_FACTOR = 1.6 
UPWARD_OFFSET_FACTOR = 0.3 --when stepping the torso moves upward not just the leg, it moves up this fraction compared to what fraction the leg moves up
-----------------------------------------------------------------------------------------------------------------------------------------------------------------
